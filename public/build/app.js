...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/AttendanceHistory.vue": () => import("./assets/AttendanceHistory-C_8vazAG.js"), "./pages/Dashboard.vue": () => import("./assets/Dashboard-B9Usm_W7.js"), "./pages/Information.vue": () => import("./assets/Information-Diwn7dSB.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-Dr-7jBvn.js"), "./pages/admin/Dashboard.vue": () => import("./assets/Dashboard-DORLvBpO.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-CqqSMBA0.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-CU3Bn8s2.js"), "./pages/auth/Login.vue": () => import("./assets/Login-D25rAEBb.js"), "./pages/auth/Register.vue": () => import("./assets/Register-Cv-gfGsr.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-BwEP9sf8.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-83diPoqU.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-I3-OznPM.js"), "./pages/settings/Password.vue": () => import("./assets/Password-Dxg43uC9.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-Ds0JkHWl.js"), "./pages/settings/SettingProfile.vue": () => import("./assets/SettingProfile-C3fqLo-y.js") })),
